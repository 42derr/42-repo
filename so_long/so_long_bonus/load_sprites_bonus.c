...
{
    data->sprites[1][0] = mlx_xpm_file_to_image(data->mlx, "textures/char/back/back1.xpm", &data->texture_length, &data->texture_length);
    if (!data->sprites[1][0])
        return (ft_putstr_fd("Failed to load textures/char/back/back1.xpm", 2), 1);
    data->sprites[1][1] = mlx_xpm_file_to_image(data->mlx, "textures/char/back/back2.xpm", &data->texture_length, &data->texture_length);
    if (!data->sprites[1][1])
        return (ft_putstr_fd("Failed to load textures/char/back/back2.xpm", 2), 1);
    data->sprites[1][2] = mlx_xpm_file_to_image(data->mlx, "textures/char/back/back3.xpm", &data->texture_length, &data->texture_length);
    if (!data->sprites[1][2])
        return (ft_putstr_fd("Failed to load textures/char/back/back3.xpm", 2), 1);
    data->sprites[1][3] = mlx_xpm_file_to_image(data->mlx, "textures/char/back/back4.xpm", &data->texture_length, &data->texture_length);
    if (!data->sprites[1][3])
...
{
    data->sprites[2][0] = mlx_xpm_file_to_image(data->mlx, "textures/char/right/right1.xpm", &data->texture_length, &data->texture_length);
    if (!data->sprites[2][0])
        return (ft_putstr_fd("Failed to load textures/char/right/right1.xpm", 2), 1);
    data->sprites[2][1] = mlx_xpm_file_to_image(data->mlx, "textures/char/right/right2.xpm", &data->texture_length, &data->texture_length);
    if (!data->sprites[2][1])
        return (ft_putstr_fd("Failed to load textures/char/right/right2.xpm", 2), 1);
    data->sprites[2][2] = mlx_xpm_file_to_image(data->mlx, "textures/char/right/right3.xpm", &data->texture_length, &data->texture_length);
    if (!data->sprites[2][2])
        return (ft_putstr_fd("Failed to load textures/char/right/right3.xpm", 2), 1);
    data->sprites[2][3] = mlx_xpm_file_to_image(data->mlx, "textures/char/right/right4.xpm", &data->texture_length, &data->texture_length);
    if (!data->sprites[2][3])
...
{
    data->sprites[3][0] = mlx_xpm_file_to_image(data->mlx, "textures/char/left/left1.xpm", &data->texture_length, &data->texture_length);
    if (!data->sprites[3][0])
        return (ft_putstr_fd("Failed to load textures/char/left/left1.xpm", 2), 1);
    data->sprites[3][1] = mlx_xpm_file_to_image(data->mlx, "textures/char/left/left2.xpm", &data->texture_length, &data->texture_length);
    if (!data->sprites[3][1])
        return (ft_putstr_fd("Failed to load textures/char/left/left2.xpm", 2), 1);
    data->sprites[3][2] = mlx_xpm_file_to_image(data->mlx, "textures/char/left/left3.xpm", &data->texture_length, &data->texture_length);
    if (!data->sprites[3][2])
        return (ft_putstr_fd("Failed to load textures/char/left/left3.xpm", 2), 1);
    data->sprites[3][3] = mlx_xpm_file_to_image(data->mlx, "textures/char/left/left4.xpm", &data->texture_length, &data->texture_length);
    if (!data->sprites[3][3])
