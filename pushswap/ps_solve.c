...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/25 19:25:08 by dfasius           #+#    #+#             */
/*   Updated: 2024/07/25 19:31:42 by dfasius          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (push->astart[0] == 1 && push->astart[1] == 2
		&& push->astart[2] == 0)
	{
		ft_putstr_fd("sa\n", 1);
		ft_putstr_fd("ra\n", 1);
	}
	else if (push->astart[0] == 2 && push->astart[1] == 0
		&& push->astart[2] == 1)
		ft_putstr_fd("sa\n", 1);
	else if (push->astart[0] == 0 && push->astart[1] == 2
		&& push->astart[2] == 1)
		ft_putstr_fd("rra\n", 1);
	else if (push->astart[0] == 1 && push->astart[1] == 0
		&& push->astart[2] == 2)
		ft_putstr_fd("ra\n", 1);
	else if (push->astart[0] == 0 && push->astart[1] == 1
		&& push->astart[2] == 2)
	{
		ft_putstr_fd("sa\n", 1);
		ft_putstr_fd("rra\n", 1);
